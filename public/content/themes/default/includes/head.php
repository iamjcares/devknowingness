...
<?php if (isset($course->id)): ?>
    ...
    <meta itemprop="image" content="<?= ($settings->enable_https) ? secure_url('/') : URL::to('/') ?><?= ImageHandler::getImage($course->image, 'large') ?>">

    <!-- for Facebook -->
    <meta property="og:title" content="<?= $course->title ?>" />
    <meta property="og:type" content="course.other" />
    <meta property="og:image" content="<?= ($settings->enable_https) ? secure_url('/') : URL::to('/') ?><?= ImageHandler::getImage($course->image, 'large') ?>" />
    ...
    <meta name="twitter:image" content="<?= ($settings->enable_https) ? secure_url('/') : URL::to('/') ?><?= ImageHandler::getImage($course->image, 'large') ?>" />
...
<script>if (!window.jQuery) {
        document.write('<script src="<?= THEME_URL . '/assets/js/jquery.min.js'; ?>"><\/script>'); }</script>
