        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="panel panel-primary" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        <p>Default number of courses to show per page:</p>
                        <input type="text" class="form-control" name="courses_per_page" id="courses_per_page" placeholder="# of Courses Per Page" value="@if(!empty($settings->courses_per_page)){{ $settings->courses_per_page }}@endif" />
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
