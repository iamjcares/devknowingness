...
<div class="admin-section-title">
    <div class="row">
        <div class="col-md-12">
            <h3><i class="entypo-archive"></i> Course Categories</h3><a href="javascript:;" onclick="jQuery('#add-new').modal('show');" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add New</a>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">New Course Category</h4>
            </div>

            <div class="modal-body">
                <form id="new-cat-form" accept-charset="UTF-8" action="{{ URL::to('admin/courses/categories/store') }}" method="post">
                    ...
                    <label for="slug">URL slug (ex. courses/categories/slug-name)</label>
        ...
        <div id="nestable" class="nested-list dd with-margins">
            ...
            <ol class="dd-list">
                ...
                <li class="dd-item" data-id="{{ $category->id }}">
                    <div class="dd-handle">{{ $category->name}}<span class="slug">courses/categories/{{ $category->slug }}</span></div>
                    <div class="actions"><a href="/admin/courses/categories/edit/{{ $category->id }}" class="edit">Edit</a> <a href="/admin/courses/categories/delete/{{ $category->id }}" class="delete">Delete</a></div>
...
<script type="text/javascript">
                ...
                jQuery(document).ready(function ($) {
                    ...
                    $('.dd').on('change', function (e) {
                        ...
                        $.post('/admin/courses/categories/order', {order: JSON.stringify($('.dd').nestable('serialize')), _token: $('#_token').val()}, function (data) {
                            console.log(data);
